/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 91ea71daad88a4822f882b754e7b4d7c)
...
declare namespace Cloudflare {
	interface Env {
		...
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* training-app */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "NEXTJS_ENV">> {}
}
